...
//	}
    ...
    func isDomainWhiteListed(_ hostname: String) -> Bool{
        let response = Engine.sharedInstance.getBridge().callAction("antitracking:isSourceWhitelisted", args: [hostname as AnyObject])
    ...
    fileprivate func addToWhiteList(_ domain: String){
        Engine.sharedInstance.getBridge().publishEvent("antitracking:whitelist:add", args: [domain as AnyObject])
    }
    
    fileprivate func removeFromWhitelist(_ domain: String){
        Engine.sharedInstance.getBridge().publishEvent("antitracking:whitelist:remove", args: [domain as AnyObject])
    }
