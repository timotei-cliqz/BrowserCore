...
let trackerViewDismissedNotification = Notification.init(name: Notification.Name(rawValue: "TrackerViewDismissed"))
...
class TrackersController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let blockAll = UIBarButtonItem(title: "Block all", style: .plain, target: self, action: #selector(blockAllPressed))
    ...
    @objc func donePressed(_ button: UIBarButtonItem) {
        NotificationCenter.default.post(trackerViewDismissedNotification)
